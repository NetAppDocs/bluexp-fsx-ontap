...
.. If you selected optimization (FlexGroup), you must specify the number of constituents and select one or more aggregates to distribute volume data across. We strongly recommend using an even number of constituents to ensure even data distribution. 
+
