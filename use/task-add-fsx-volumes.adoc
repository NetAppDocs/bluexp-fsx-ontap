...
. Select the *Volume* tab and *Manage Volume* to open the *Volume Actions* menu. 
+
image:screenshot_fsx_volume_actions.png[A screenshot of how to open the Volume Actions menu.]

. Select *Mount command* and follow the instructions to mount the volume.
