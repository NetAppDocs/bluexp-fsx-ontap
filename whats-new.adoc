...
summary: Learn what's new in Amazon FSx for NetApp NetApp ONTAP.
---

= What's new with Amazon FSx for NetApp NetApp ONTAP
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
=== Support for Amazon FSx for NetApp NetApp ONTAP
...
+
link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/start/concept-fsx-aws.html[Learn about Amazon FSx for NetApp NetApp ONTAP^].

* You can configure an FSx for ONTAP working environment in Cloud Manager.
+
link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-creating-fsx-working-environment.html[Create an Amazon FSx for NetApp NetApp ONTAP working environment^].
...
+
link:https://docs.netapp.com/us-en/cloud-manager-data-sense/task-scanning-fsx.html[Get started with Cloud Data Sense for Amazon FSx for NetApp NetApp ONTAP^].
