...
* The **My Oportunities** tab is now **My estate**. The documentation is updated to reflect the new name. 
...
+
link:https://docs.netapp.com/us-en/bluexp-fsx-ontap/use/task-creating-fsx-working-environment.html#discover-an-existing-fsx-for-ontap-file-system[Discover FSx for ONTAP using My Opportunities^]
