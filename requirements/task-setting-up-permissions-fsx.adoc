...
NOTE: Existing AWS credentials are available from BlueXP settings > *Credentials* page. Newly added credentials are displayed from BlueXP workload factory. A link is provided in the BlueXP settings credentials page to help you navigate to the workload factory credentials page. 
